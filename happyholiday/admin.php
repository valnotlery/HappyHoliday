		...
		<div class="addp-workspace work" id="id5" style="display: none;">
			<div class="insert-pform" id="insp-form4">
				<form method="POST" action="admin_op.php">
					...
					<input type="text" name="pi2" placeholder="Enter image2" ><br>
					<input type="text" name="pi3" placeholder="Enter image3" ><br>
					<input type="text" name="package" placeholder="Price" required><br>
